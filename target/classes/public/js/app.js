(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('vacations',{
	        url:'/vacations',
	        templateUrl: viewsPrefix + 'vacations.html',
	        controller:'VacationListController'
	    }).state('viewVacation',{
	       url:'/vacations/:id/view',
	       templateUrl: viewsPrefix + 'vacation-view.html',
	       controller:'VacationViewController'
	    }).state('newVacation',{
	        url:'/vacations/new',
	        templateUrl: viewsPrefix + 'vacation-add.html',
	        controller:'VacationCreateController'
	    }).state('editVacation',{
	        url:'/vacations/:id/edit',
	        templateUrl: viewsPrefix + 'vacation-edit.html',
